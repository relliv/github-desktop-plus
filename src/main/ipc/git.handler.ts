...
export function registerGitHandlers() {
  ...
  ipcMain.handle(
    'git:validate',
    async (_event: IpcMainInvokeEvent, path: string): Promise<RepositoryValidation> => {
  ...
  ipcMain.handle(
    'git:create',
    async (_event: IpcMainInvokeEvent, options: CreateRepositoryOptions) => {
  ...
  ipcMain.handle(
    ...
    async (_event: IpcMainInvokeEvent, repoPath: string): Promise<string | null> => {
  ...
  ipcMain.handle(
    'git:getRemoteUrl',
    async (_event: IpcMainInvokeEvent, repoPath: string): Promise<string | undefined> => {
